...
class LeftToRightAnim extends StatefulWidget {
  final Widget child;
  final int milliSecond;
  LeftToRightAnim({required this.child, required this.milliSecond});

  @override
  State<LeftToRightAnim> createState() => _LeftToRightAnimState();
}

class _LeftToRightAnimState extends State<LeftToRightAnim>
